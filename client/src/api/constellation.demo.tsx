      ...
      "data": [
        {
          "nickname": "admin",
          "deviceName": "phone",
          "publicKey": "-----BEGIN Nimbus X25519 PRIVATE KEY-----\naACf/...=\n-----END Nimbus X25519 PRIVATE KEY-----\n",
          "ip": "192.168.201.4/24",
          "isLighthouse": false,
          "isRelay": true,
          "publicHostname": "",
  ...
  return new Promise((resolve, reject) => {
    resolve({
      "data": {
        ...
        "Nickname": "admin",
        "Port": "4242",
        "PrivateKey": "-----BEGIN Nimbus CERTIFICATE-----\...//w8o3ZaFqQYwhdGFuAY6IGXmYRCr3z932Y....w\..==\n-----END Nimbus CERTIFICATE-----\n",
        "PublicHostname": "",
